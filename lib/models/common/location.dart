...
import 'package:todo_admin/models/references/city.dart';
import 'package:todo_admin/models/references/country.dart';
import 'package:todo_admin/models/references/state.dart';
...
class LocationModel extends anxeb.Model<LocationModel> {
  ...
  void init() {
    ...
    field(() => state, (v) => state = v, 'state', instance: (data) => data != null ? StateReference(data) : null);
    field(() => city, (v) => city = v, 'city', instance: (data) => data != null ? CityReference(data) : null);
  ...
  static Future<LocationModel> lookup({anxeb.Scope scope, IconData icon, String title, ReferenceType leaf}) async {
  ...
  @override
  String toString() => (city ?? state ?? country)?.name ?? super.toString();
