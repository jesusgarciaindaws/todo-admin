  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: anxeb.ImageButton(
        ...
        imageUrl: scope.application.api.getUri('$logoUrl?webp=80&t=${tick?.toString()}'),
        ...
        imagePadding: flat == true ? EdgeInsets.zero : const EdgeInsets.only(left: 10, right: 10, top: 5, bottom: 5),
        ...
        failedBody: Row(
          children: <Widget>[
            Container(
              ...
              child: failedIcon ?? const Icon(anxeb.FontAwesome5.building, size: 40),
            ),
            Expanded(
              child: Container(
